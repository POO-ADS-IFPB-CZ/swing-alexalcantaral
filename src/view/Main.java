...
public class Main {
    ...
    private void cadastrarProduto() {
        ...
        if (result == JOptionPane.OK_OPTION) {
            try {
                ...
                model.Produto produto = new model.Produto(id, descricao, preco, validade);
    ...
    private void listarProdutos() {
        try {
            Set<model.Produto> produtos = produtoDAO.getProdutos();
            if (produtos.isEmpty()) {
        ...
        try {
            ...
            for (model.Produto p : produtos) {
                if (p.getId() == id) {
                    ...
                    model.Produto produtoAtualizado = new model.Produto(id, novaDescricao, novoPreco, novaValidade);
